...
int main_client()
{
    ...
    {
        std::cout << "Error en la creación del socket." << std::endl;
        return -1;
    }
    ...
    {
        std::cout << "Dirección no válida/ Dirección no soportada." << std::endl;
        return -1;
    }
    ...
    // send(sock, "Hola desde el cliente", strlen("Hola desde el cliente"), 0);
